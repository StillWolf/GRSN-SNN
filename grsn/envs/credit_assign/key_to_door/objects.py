...
class ObjectSprite(plab_things.Sprite):
    ...
    def __init__(
        self, corner, position, character, reward=0.0, collectable=True, terminate=True
    ):
...
class IndicatorObjectSprite(plab_things.Sprite):
    ...
    def __init__(
        self, corner, position, character, char_to_track, override_position=None
    ):
