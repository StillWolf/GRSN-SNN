...
from grsn.algorithms import RL_ALGORITHMS
...
class ModelFreeOffPolicy_Separate_SNN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gamma = gamma
        self.tau = tau
        if algo_name == 'sac' or algo_name == 'sacd':
            entropy_alpha = kwargs['kwargs']['entropy_alpha']
            automatic_entropy_tuning = kwargs['kwargs']['automatic_entropy_tuning']
            target_entropy = kwargs['kwargs']['target_entropy']
            alpha_lr = kwargs['kwargs']['alpha_lr']
            self.algo = RL_ALGORITHMS[algo_name](action_dim=action_dim, entropy_alpha=entropy_alpha,
